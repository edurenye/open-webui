...
app.state.config.DEFAULT_IMAGE_GENERATION_ENGINE = DEFAULT_IMAGE_GENERATION_ENGINE
app.state.config.ENABLE_IMAGE_GENERATION = ENABLE_IMAGE_GENERATION
app.state.config.ENABLE_IMAGE_PROMPT_GENERATION = ENABLE_IMAGE_PROMPT_GENERATION

app.state.config.OPENAI_IMAGE_CONFIG = OPENAI_IMAGE_CONFIG
app.state.config.AUTOMATIC1111_CONFIG = AUTOMATIC1111_CONFIG
app.state.config.COMFYUI_CONFIG = COMFYUI_CONFIG
app.state.config.GEMINI_CONFIG = GEMINI_CONFIG
